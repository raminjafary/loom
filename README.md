...
through that queue rather than racing (PLAN.md §5a).
...
- No reconciler agent in front of the merge queue (PLAN.md §7 Phase 2 wants the queue as
  its fallback; the queue exists, the agent does not).
