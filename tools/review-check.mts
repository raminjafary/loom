...
/**
 * The reviewer holds no `Edit` and no `Write`, which is the persona-level half of the * "no path ownership": the platform gives it no paths, and this gives it nothing to
 * write with either. Its whole output is notes.
 */
const REVIEWER = [
 '---',
 'name: review-checker',
