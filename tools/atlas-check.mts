 ...
 *    would be a second place for the untrusted framing to drift, and the fence is the whole
 *    of the planner/worker trust boundary for a report about a repository this run cannot
 *    open.
