 ...
 * LOOM_SANDBOX_MODEL_API_KEY to exercise the sandboxed path instead (PLAN.md §6, A6
 * caveat explains why that needs a real key).
 *
...
const main = async () => {
  ...
  // provisioning (PLAN.md §3a) — so the driver authors its own persona.
