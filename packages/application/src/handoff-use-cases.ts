 ...
 * The nudge.
 *
 * Called from the heartbeat, which is the frame that already carries the measurement live
 * swarm observability takes and mastery acts on — so the platform notices a filling window
 * at the moment it fills rather than the next time somebody looks at the board.
 *
