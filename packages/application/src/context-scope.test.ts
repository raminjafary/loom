...
describe('inScopeRunIds', => {
 /**
 * The measured behaviour, and the reason the rule includes siblings at
 * all: the parallel-branch measurement found peer coordination to be what prevents conflicts. In a flat tree
 * this rule must admit everything, or Phase 2 regresses.
 */
