 ...
 *
 * Every test here is one of the four properties mastery says a venue needs — a fixed
 * roster, a spend ceiling, a transcript, a verdict — doing its job at the moment a turn is
 * taken. The venue's rules are worth nothing if the exchange can walk around them.
 */
