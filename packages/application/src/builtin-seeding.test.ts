 ...
 * The planner/worker trust boundary was later amended to give a planner read-only tools
 * *because* the empty list made sub-planners stall on the approval SLA. Every existing
 * workspace kept the version that stalls, a new one got the fix, and nothing said so.
 */
