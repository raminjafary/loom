...
export interface AgentSnapshot {
   ...
   * several at once (PLAN.md §7 Phase 2): a human watches one at a time even when
   * three are executing.
   */
...
export interface AgentSession {
  ...
  /**
   * Switches which of several concurrent runs this client is watching (PLAN.md §7
   * Phase 2). Does not stop or change anything server-side — it is purely which
