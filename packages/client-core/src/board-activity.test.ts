...
describe('describeCardActivity', () => {
  ...
  /**
   * The label says how long the silence has been, never what it means: live swarm
   * observability names both possibilities — thinking hard, or wedged — and the platform
...
/**
 * The context pressure. Reported even for a finished run: "how full was its window when it
 * stopped" is exactly the post-mortem question, and it is also the figure the warm handoff
 * triggers on.
 */
