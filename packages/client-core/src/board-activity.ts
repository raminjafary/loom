...
/**
 * When quiet becomes worth mentioning. Live swarm observability: "A run that has not
 * emitted in four minutes is either thinking hard or wedged." The platform genuinely cannot
 * tell those apart, so this threshold decides when to *show the silence*, and the label
 * says how long it has been rather than which of the two it is. Claiming "wedged" would be
 * a guess presented as a finding, and the dead-run reaper is the thing entitled to that
 * conclusion.
 */
