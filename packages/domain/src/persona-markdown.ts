 ...
 * need the capability registry that doesn't land until Phase 2 (§4e's own
 * phasing note) — not parsed here.
 *
 * `harness.budgetCapUsd` (default null = uncapped) is enforced, not advisory
 * (PLAN.md §6/§9): the egress proxy meters real spend against it and refuses
 ...
 * cost rather than what it reports about itself (§6 A6).
 *
