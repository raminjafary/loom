...
describe('parsePlanDelta', () => {
  it('accepts a delta that changes nothing, and that is a real answer', () => {
    // Mid-flight steering point 2: agents repair disrupted plans badly. A re-planning turn
    // that cannot say "the plan is right" will invent work to justify itself.
...
describe('buildSteeringBrief', () => {
  ...
  it('carries all four of a re-planning brief\'s inputs', () => {
    const text = brief()
