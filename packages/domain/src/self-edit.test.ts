...
describe('reviseToolList', () => {
  ...
  /**
   * The planner/worker trust boundary. A planner may read and may never act; what its
   * children hold is `delegates`, set by a human, and this tier cannot reach it.
   */
