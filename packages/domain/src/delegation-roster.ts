 ...
 *
 * **[NEW — and it existed by accident until the merge gate removed the accident.]** The
...
export const PLATFORM_STARTED_PERSONAS: readonly string[] = [
   ...
   * platform starts it when a variant search opens, and its whole context is a blinded set
   * of options a planner has no way to supply. A subtask assigned to it is a subtask that
