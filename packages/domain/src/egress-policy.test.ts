...
describe('a recorded decision', () => {
  ...
  /**
   * the egress record's complaint about today's behaviour is that a refusal reaches stdout
   * and teaches nobody, so the line has to say what to do — and say it about the
   * *capability*, since the deployment allowlist is shared by every agent.
   */
