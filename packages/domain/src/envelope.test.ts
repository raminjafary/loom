...
describe('envelopeAllows', () => {
  ...
  /**
   * Continuity mode: "rejected and surfaced to a human as a request, not silently clamped —
   * clamping teaches an agent to probe." So every refusal names the widening, and nothing
   * here returns a narrowed value.
   */
