...
describe('nextVariantArm', () => {
  /**
   * The rule rather than the self-improvement loop's, and the asymmetry is the point:
   * nothing is live yet, so the honest first sample is the prompt the workspace actually
   * has.
   */
