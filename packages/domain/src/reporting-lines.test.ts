 ...
 * roster is the sub-planners. That is the corporation shape the corporation describes, and it is
 * not expressible by depth — which is reachability, and reachability is flat.
 */
 ...
 * nothing ever reads — a control the runtime ignores, which the roadmap forbids on this canvas.
 */
