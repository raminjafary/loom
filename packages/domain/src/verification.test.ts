...
describe('parseVerificationChecks', () => {
  ...
  // A duplicate name makes both results unreadable — and the self-improvement loop compares
  // runs by check name, so it would make two different measurements the same measurement.
