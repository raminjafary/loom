 ...
 *
 * The rule these tests are written against is the roadmap's, quoted in the canvas design: a
 * design canvas "may only draw what the runtime executes, so each of these has to be a
 * field the platform already reads — never a decoration." So what is pinned here is the two
 * things the runtime does with it: what a Planner is *told*, and what a plan is *warned*
 * about.
 */
