 ...
 * position.
 *
 * **The two are in separate sections and only one of them is fenced**, and the split is the
 * point. What the *other* participants said is another model's output — untrusted,
 ...
 * quoted back for the one reason mastery gives: factual attrition is claims a speaker held
 * at the opening and no longer mentions, and a speaker that cannot see its own opening
