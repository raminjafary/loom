 ...
 *
 * Effect-based classification's complaint about name-based gating is precise: `Bash`
 * subsumes every risky category, so gating on the name "either over-gates (approval
 * fatigue) or under-gates (a disallowed effect inside an allowed tool)". This module
 * attacks both ends, and is explicit about the middle it cannot fix.
 *
