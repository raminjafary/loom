...
/**
 * The raw tier is redacted at write. It is the one artifact deliberately not summarized,
 * so it is precisely where a leaked credential would sit verbatim and indefinitely.
 *
