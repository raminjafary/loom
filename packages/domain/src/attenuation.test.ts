...
/**
 * The attenuation rule, one test per way a swarm could otherwise be used to acquire what
 * its parent was denied. The Planner case is the sharpest: the product shape gives a
 * Planner `tools: []` on purpose, and without these checks it could just spawn a child that
 * has them.
 */
