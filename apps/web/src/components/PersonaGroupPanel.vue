...
const emit = defineEmits<{
 ...
 /** Opens the composition canvas on this group. */
 compose: []
}>
...
<template>
 ...
 <!--
 The canvas is where the roster becomes a picture and the attenuation envelope
 becomes visible. Disabled rather than hidden with no
 groups, so its absence is a state rather than a missing feature.
 -->
 <button
 type="button"
 class="link"
