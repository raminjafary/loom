...
/**
 * The global kill switch. Lives in the top bar rather than the sidebar so it is reachable
 * from every view — a stop control you have to navigate to is not one button.
 */
