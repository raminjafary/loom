...
/**
 * Settling a variant search: a candidate promoted, or none of them. One handler because it
 * is one act, and two calls because they are two writes.
 */
...
<template>
  <div class="app">
    ...
    <SettingsOverlay
      ...
      :archive-workflow="agent.archiveWorkflow"
      :export-persona="agent.exportPersona"
      :adopt-persona="agent.adoptPersona"
      :read-persona-divergence="agent.personaDivergence"
      :open-run="openRun"
