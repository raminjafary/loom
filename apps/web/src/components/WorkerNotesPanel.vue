 ...
 * read and write.
 *
 * **The rendering carries a security requirement, not a style preference.** the worker-notes design:
 * "agent-authored notes render inside a clearly delimited untrusted block, the persona
 * and the human-visible plan stay authoritative over what a worker does, and the
 * **platform** separately writes the structural facts it knows first-hand … which the
 * UI must show as distinct from agent prose."
 *
