...
const props = defineProps<{
  runners: Runner[]
  lastPairing: { runnerId: string; rawToken: string } | null
}>()
...
<template>
  <section class="panel">
    ...
    <p v-if="props.lastPairing" class="pairing-token" role="status">
      Token for <strong>{{ props.lastPairing.runnerId }}</strong> (copy now, shown once):
