...
<template>
 ...
 <!--
 A question is composed by a model, so it is attacker-controllable text and gets the same fence as any agent prose. An agent that could
 ask "paste your token here" in a box wearing the platform's own chrome is the risk in a different shape — hence the explicit label, and hence plain
 interpolation rather than any markup path.
 -->
