 ...
 *   which persona gets which piece, what waits for what, and who reviews whom. So the
 *   stages are drawn as stages — the DAG is the thing being approved, and a flat list hides
 *   the one property that makes a plan cheap or expensive.
