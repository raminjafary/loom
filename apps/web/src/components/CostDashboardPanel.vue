 ...
 * The cost dashboard.
 *
 * Distinct from `RunTreePanel`, which rolls up **one tree**: this is the workspace, and
 * the difference is the point. A tree answers "what did this goal cost"; the cost model asks what
 * the workspace is costing and *where the money goes* — "Cursor's 8x swing came from
