...
/**
 * The allowed-root boundary, applied to the two capabilities that browse and create
 * rather than merely validate. The stakes are direct: without the boundary, an agent can
 * be aimed at `~/.ssh`. A picker is the most tempting way past it, because listing a
 * directory looks like it does nothing.
 */
