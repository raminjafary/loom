...
/**
 * PLAN.md §7 Phase 1 lists backpressure among the things that make apps/runner a
 * real distributed component rather than a happy-path script. Each test below is
