...
/**
 * The merge queue's git, against real repositories (PLAN.md §7 Phase 2). Mocking
...
describe('mergeRunBranch', () => {
  ...
  /**
   * The queue's whole reason for existing (§5a: "sibling branches converge through
  ...
  /**
   * §6 A5's boundary, at the one point the merge queue could quietly cross it: the
