 ...
 *
 * The argument is an **enum of the letters that were actually offered**, which is the point.
 * The self-improvement loop needs a verdict that is a choice among blinded options; a free-text answer would let
 * a model reply "the second one" or invent an option, and the server would then be guessing
 * what it meant about the one fact this whole session exists to produce.
 *
