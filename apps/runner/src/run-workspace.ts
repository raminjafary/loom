 ...
 *
 * Not optional, and not the model's job. PLAN.md §5a renders "the run's branch diff"
 * for review and §6 A2 pushes `HEAD:refs/heads/<branch>` — both are empty if the agent
